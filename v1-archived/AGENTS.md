...
## Feature Workflow
Feature workflow is done in `thoughts/features/`, which is a sim linked directory. Folder names use Linear ticket numbers (for example, `thoughts/features/MOS-123/`, and we track everything in Linear.
